{strip}
    <div class="lpa-edit-address">
        {* TPL for the login address form - basically the inc_billing_address form but it only shows required information and has some slight changes, also it can handle BS3 and BS4 *}
        <fieldset>
            <legend class="lpa-mandatory-title">{lang key="mandatoryFields" section="global"}</legend>
            {* salutation / title *}
            <div class="row">
                {if $Einstellungen.kunden.kundenregistrierung_abfragen_anrede === 'Y' || (!$lpaCreate.requiredFieldsOnly && $Einstellungen.kunden.kundenregistrierung_abfragen_anrede !== 'N')}
                ...
                {if $Einstellungen.kunden.kundenregistrierung_abfragen_titel === 'Y' || (!$lpaCreate.requiredFieldsOnly && $Einstellungen.kunden.kundenregistrierung_abfragen_titel !== 'N')}
                    <div class="col-12 col-xs-12 col-md-6">
                        ...
                        {else}
                            {assign var='inputVal_title' value=''}
                        {/if}
            ...
            <div class="row">
                <div class="col-12 col-xs-12 col-md-6">
                    ...
                    {elseif isset($lpaCreate['userInfoFirstName'])}
                        {assign var='inputVal_firstName' value=$lpaCreate['userInfoFirstName']}
                    {else}
                        {assign var='inputVal_firstName' value=''}
                    {/if}
                    <div class="lpa-edit-firstname" data-value="{$inputVal_firstName}">
                        {include file='snippets/form_group_simple.tpl'
                        options=[
                ...
                <div class="col-12 col-xs-12 col-md-6">
                    ...
                    {elseif isset($lpaCreate['userInfoLastName'])}
                        {assign var='inputVal_lastName' value=$lpaCreate['userInfoLastName']}
                    {else}
                        {assign var='inputVal_lastName' value=''}
                    {/if}
                    <div class="lpa-edit-lastname" data-value="{$inputVal_lastName}">
                        {include file='snippets/form_group_simple.tpl'
                        options=[
            ...
            {* firm / firmtext *}
            <div class="row">
                {if $Einstellungen.kunden.kundenregistrierung_abfragen_firma === 'Y' || (!$lpaCreate.requiredFieldsOnly && $Einstellungen.kunden.kundenregistrierung_abfragen_firma !== 'N')}
                    <div class="col-12 col-xs-12 col-md-6">
                        ...
                        {else}
                            {assign var='inputVal_firm' value=''}
                        {/if}
                        {include file='snippets/form_group_simple.tpl'
                        options=[
                        'text', 'firm', 'firma',
                ...
                {if $Einstellungen.kunden.kundenregistrierung_abfragen_firmazusatz === 'Y' || (!$lpaCreate.requiredFieldsOnly && $Einstellungen.kunden.kundenregistrierung_abfragen_firmazusatz !== 'N')}
                    <div class="col-12 col-xs-12 col-md-6">
                        ...
                        {else}
                            {assign var='inputVal_firmext' value=''}
                        {/if}
                        {include file='snippets/form_group_simple.tpl'
                        options=[
            ...
            <div class="row">
                <div class="col-12 col-xs-12 col-md-8">
                    ...
                    {else}
                        {assign var='inputVal_street' value=''}
                    {/if}
                    <div class="lpa-edit-street" data-value="{$inputVal_street}">
                        {include file='snippets/form_group_simple.tpl'
                        options=[
                        'text', 'street', 'strasse',
                ...
                <div class="col-12 col-xs-12 col-md-4">
                    ...
                    {else}
                        {assign var='inputVal_streetnumber' value=''}
                    {/if}
                    <div class="lpa-edit-streetnumber" data-value="{$inputVal_streetnumber}">
                        {include file='snippets/form_group_simple.tpl'
                        options=[
            ...
            {* adress addition *}
            {if $Einstellungen.kunden.kundenregistrierung_abfragen_adresszusatz === 'Y' || (!$lpaCreate.requiredFieldsOnly && $Einstellungen.kunden.kundenregistrierung_abfragen_adresszusatz !== 'N')}
                <div class="row">
                    <div class="col-xs-12 col-md-6">
                        ...
                        {else}
                            {assign var='inputVal_street2' value=''}
                        {/if}
                        {include file='snippets/form_group_simple.tpl'
                        options=[
            ...
            <div class="row">
                <div class="col-12 col-xs-12 col-md-6">
                    <div class="lpa-edit-country" data-value="{$cIso}">
            ...
            {if $Einstellungen.kunden.kundenregistrierung_abfragen_bundesland === 'Y' || (!$lpaCreate.requiredFieldsOnly && $Einstellungen.kunden.kundenregistrierung_abfragen_bundesland !== 'N')}
                ...
                <div class="row">
                <div class="col-12 col-xs-12 col-md-6">
                    <div class="lpa-edit-state" data-value="{$cState}">
                        <div class="form-group float-label-control{if isset($fehlendeAngaben.bundesland)} has-error{/if}">
                            ...
                            {else}
                                <input
                                        type="text"
                                        title="{lang key='state' section='account data'}"
                                        name="bundesland"
                                        value="{$cState}"
                                        id="state"
                                        class="form-control"
            ...
            <div class="row">
                <div class="col-12 col-xs-12 col-md-3">
                    <div class="lpa-edit-zip" data-value="{if isset($cPost_var['plz'])}{$cPost_var['plz']}{elseif isset($Kunde->cPLZ)}{$Kunde->cPLZ}{/if}">
                ...
                <div class="col-12 col-xs-12 col-md-6">
                    <div class="lpa-edit-city" data-value="{if isset($cPost_var['ort'])}{$cPost_var['ort']}{elseif isset($Kunde->cOrt)}{$Kunde->cOrt}{/if}">
            ...
            {* UStID *}
            {if $Einstellungen.kunden.kundenregistrierung_abfragen_ustid === 'Y' || (!$lpaCreate.requiredFieldsOnly && $Einstellungen.kunden.kundenregistrierung_abfragen_ustid !== 'N')}
                <div class="row">
                    <div class="col-12 col-xs-12 col-md-6">
                            ...
                            {if isset($fehlendeAngaben.ustid)}
                                <div class="form-error-msg text-danger"><i class="fa fa-warning"></i>
                                    ...
                                    {elseif $fehlendeAngaben.ustid == 2}
                                        {$errorinfo=explode(',', $fehlendeAngaben.ustid_err)}
        ...
        <fieldset>
            ...
            <div class="row">
                <div class="col-12 col-xs-12 col-md-6">
                    ...
                    {elseif isset($lpaCreate.mail)}
                        {assign var='inputVal_email' value=$lpaCreate.mail}
                    {else}
                        {assign var='inputVal_email' value=''}
                    {/if}
                    <div class="lpa-edit-mail" data-value="{$inputVal_email}">
                        <div class="form-group{if isset($fehlendeAngaben, $fehlendeAngaben.email) && $fehlendeAngaben.email > 0} has-error{/if}">
                            <label for="email" class="control-label float-label-control">{lang key='email' section='account data'}</label>
                            <input type="email" name="email" value="{$inputVal_email}" id="email" class="form-control"
                                   placeholder="{lang key='email' section='account data'}" required readonly>
                            {if isset($fehlendeAngaben, $fehlendeAngaben.email)}
                                {assign var='errCodeEmail' value=$fehlendeAngaben.email}
                                {if $errCodeEmail == 1}
                                    {lang assign='invalidReasonEmail' key='fillOut' section='global'}
                                {elseif $errCodeEmail == 2}
                                    {lang assign='invalidReasonEmail' key='invalidEmail' section='global'}
                                {elseif $errCodeEmail == 3}
                                    {lang assign='invalidReasonEmail' key='blockedEmail' section='global'}
                                {elseif $errCodeEmail == 4}
                                    {lang assign='invalidReasonEmail' key='noDnsEmail' section='account data'}
                                {elseif $errCodeEmail == 5}
                                    {lang assign='invalidReasonEmail' key='emailNotAvailable' section='account data'}
                                {/if}
                                {if isset($invalidReasonEmail) && $invalidReasonEmail|strlen > 0}
                                    <div class="form-error-msg text-danger"><i class="fa fa-warning"></i> {$invalidReasonEmail}</div>
                                {/if}
                            {/if}
                        </div>
                    </div>
            ...
            {if $Einstellungen.kunden.kundenregistrierung_abfragen_tel === 'Y' || (!$lpaCreate.requiredFieldsOnly && $Einstellungen.kunden.kundenregistrierung_abfragen_tel !== 'N')}
                <div class="row">
                    <div class="col-12 col-xs-12 col-md-6">
                        ...
                        {else}
                            {assign var='inputVal_tel' value=''}
                        {/if}
                        <div class="lpa-edit-tel" data-value="{$inputVal_tel}">
                            {include file='snippets/form_group_simple.tpl'
                            options=[
                            'tel', 'tel', 'tel',
            ...
            {if $Einstellungen.kunden.kundenregistrierung_abfragen_fax === 'Y' || (!$lpaCreate.requiredFieldsOnly && $Einstellungen.kunden.kundenregistrierung_abfragen_fax !== 'N')}
                <div class="row">
                    <div class="col-12 col-xs-12 col-md-6">
            ...
            {if $Einstellungen.kunden.kundenregistrierung_abfragen_mobil === 'Y' || $Einstellungen.kunden.kundenregistrierung_abfragen_www === 'Y'|| (!$lpaCreate.requiredFieldsOnly && $Einstellungen.kunden.kundenregistrierung_abfragen_mobil !== 'N') || (!$lpaCreate.requiredFieldsOnly && $Einstellungen.kunden.kundenregistrierung_abfragen_www !== 'N')}
                <div class="row">
                    {if $Einstellungen.kunden.kundenregistrierung_abfragen_mobil === 'Y' || (!$lpaCreate.requiredFieldsOnly && $Einstellungen.kunden.kundenregistrierung_abfragen_mobil !== 'N')}
                        <div class="col-12 col-xs-12 col-md-6">
                            ...
                            {else}
                                {assign var='inputVal_mobile' value=''}
                            {/if}
                            {include file='snippets/form_group_simple.tpl'
                            options=[
                            'tel', 'mobile', 'mobil',
                    ...
                    {if $Einstellungen.kunden.kundenregistrierung_abfragen_www === 'Y' || (!$lpaCreate.requiredFieldsOnly && $Einstellungen.kunden.kundenregistrierung_abfragen_www !== 'N')}
                        <div class="col-12 col-xs-12 col-md-6">
            ...
            {if $Einstellungen.kunden.kundenregistrierung_abfragen_geburtstag === 'Y' || (!$lpaCreate.requiredFieldsOnly && $Einstellungen.kunden.kundenregistrierung_abfragen_geburtstag !== 'N')}
                <div class="row">
                    <div class="col-12 col-xs-12 col-md-6">
                        ...
                        {else}
                            {assign var='inputVal_birthday' value=''}
                        {/if}
                        {include file='snippets/form_group_simple.tpl'
                        options=[
                ...
                <div class="row">
                    <div class="col-12 col-xs-12 col-md-6">
                        {foreach $oKundenfeld_arr as $oKundenfeld}
                            {if $oKundenfeld->isRequired() || !$lpaCreate.requiredFieldsOnly}
                                ...
                                <div class="form-group float-label-control{if isset($fehlendeAngaben.custom[$kKundenfeld])} has-error{/if}">
                                    ...
                                    {if $oKundenfeld->getType() !== 'auswahl'}
                                        <input
                                                type="{if $oKundenfeld->getType() === 'zahl'}number{elseif $oKundenfeld->getType() === 'datum'}date{else}text{/if}"
                                                name="custom_{$kKundenfeld}"
                                                id="custom_{$kKundenfeld}"
                                                value="{if isset($Kunde->cKundenattribut_arr[$kKundenfeld])}{$Kunde->cKundenattribut_arr[$kKundenfeld]->getValue()}{/if}"
                                                class="form-control"
                                    ...
                                    {else}
                                        <select name="custom_{$kKundenfeld}" class="form-control" {if $oKundenfeld->isRequired()}required{/if}>
                                            ...
                                            {foreach $oKundenfeld->getValues() as $oKundenfeldWert}
                                                <option value="{$oKundenfeldWert}" {if isset($Kunde->cKundenattribut_arr[$kKundenfeld]) && ($oKundenfeldWert == $Kunde->cKundenattribut_arr[$kKundenfeld]->getValue())}selected{/if}>{$oKundenfeldWert}</option>
                                            {/foreach}
                                        </select>
                                    {/if}
