...
class UpdateChargePermission extends AbstractOperation {
    ...
    public function __construct(string $chargePermissionId, MerchantMetadata $merchantMetadata) {
    ...
    public function getPayload(): ?array {
        return [
            'merchantMetadata' => $this->merchantMetadata->toArray()
        ];
    }
