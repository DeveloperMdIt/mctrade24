 ...
 *
 * Single tracking number and carrier code detail object.
 *
 * @package Plugin\s360_amazonpay_shop5\lib\AmazonPay\Objects
 */
class DeliveryDetail extends AbstractObject {

    public const AMAZON_CARRIER_CODES = [
        '007EX' => 'EX_007',
        ...
        'Danske FragtmÃ¦nd' => 'DANSKE_FRAGT',
        'Dawn Wing' => 'DAWNWING',
        ...
        'Hrvatska PoÅ¡ta' => 'HRVATSKA_POSTA',
        ...
        'Lietuvos PaÅ¡tas' => 'LIETUVOS_PASTAS',
        ...
        // DUPLICATE 'PICK UPP' => 'PICKUPP_SGP',
        ...
        'Asendia HK â€“ Premium Service (LATAM)' => 'SKYPOSTAL',
        'Smooth Couriers' => 'SMOOTH',
        'SMSA Express' => 'SMSA_EXPRESS',
        'Correos de EspaÃ±a' => 'SPAIN_CORREOS_ES',
    ...
    protected function fillFromArray($data) {
        ...
        $this->carrierCode = $data['carrierCode'] ?? null;
    }
    ...
    public static function isValidCarrierCode(?string $code): bool {
        if (null === $code) {
            return false;
        }
        return \in_array($code, \array_values(self::AMAZON_CARRIER_CODES), true);
    }

    public static function mapToCarrierCode(?string $carrier): ?string {
        if($carrier === null) {
            return null;
        }
        if(!\array_key_exists($carrier, self::AMAZON_CARRIER_CODES)) {
            return null;
        }
        return self::AMAZON_CARRIER_CODES[$carrier];
    }
