...
.topbar-container {
  ...
  align-items: center;
  flex-wrap: wrap;
  max-width: 1200px; /* optional, für Layoutbegrenzung */
  margin: 0 auto;
  padding: 0 1rem;
  width: 100%;
}
...
<div class="topbar-info">
    <div class="topbar-container">
        <span class="info-item">📦 Versandkostenfrei ab 39 € innerhalb Deutschland</span>
        <span class="info-item">☎ Hotline: +49 6638 / 72 92 101</span>
        <span class="info-item">🚚 Schneller & zuverlässiger Versand</span>
    </div>
</div>
{* === CUSTOM TOPBAR END === *}
