{* custom - updated to nova, some classes modified to work with Bootstrap3, icons removed because of problems *}
                                ...
                                <div id="queue{$oUploadSchema@index}" style="margin-bottom: 15px;" class="uploadifyMsg">
                                    <span class="current-upload small text-success">
                                        {if $oUploadSchema->bVorhanden}
                                            ...
                                            {$admIcon->renderIcon('check', 'icon-content icon-content icon-content--default')}
