...
//     ->registerPlugin(Smarty::PLUGIN_FUNCTION, 'getCountry', 'getCountry')
//     ->registerPlugin(Smarty::PLUGIN_MODIFIER, 'seofy', 'seofy')
//     ->registerPlugin(Smarty::PLUGIN_FUNCTION, 'getUploaderLang', 'getUploaderLang')

//     ->registerPlugin(Smarty::PLUGIN_MODIFIER,'trim', 'trim')
//     ->registerPlugin(Smarty::PLUGIN_MODIFIER,'http_build_query', 'http_build_query')
//     ->registerPlugin(Smarty::PLUGIN_MODIFIER,'strpos', 'strpos')
//     ->registerPlugin(Smarty::PLUGIN_MODIFIER,'is_array', 'is_array')
//     ->registerPlugin(Smarty::PLUGIN_MODIFIER,'strip_tags', 'strip_tags')
//     ->registerPlugin(Smarty::PLUGIN_MODIFIER,'sprintf', 'sprintf')
//     ->registerPlugin(Smarty::PLUGIN_MODIFIER,'array_reverse', 'array_reverse')
//     ->registerPlugin(Smarty::PLUGIN_MODIFIER,'intval', 'intval')
//     ->registerPlugin(Smarty::PLUGIN_MODIFIER,'max', 'max')
//     ->registerPlugin(Smarty::PLUGIN_MODIFIER,'substr', 'substr')
//     ->registerPlugin(Smarty::PLUGIN_MODIFIER,'json_encode', 'json_encode')
//     ->registerPlugin(Smarty::PLUGIN_MODIFIER,'in_array', 'in_array')
//     ->registerPlugin(Smarty::PLUGIN_MODIFIER,'htmlentities', 'htmlentities');
...
//         );
//         if ($sort > 0) {
//             $sorting = new Sort($productFilter);
//             $sorting->setActiveSortingType((int)$sort);
//             $sorting->setFactory(new Factory($productFilter));
//             $productFilter->setSorting($sorting);
//     }
...
//         $boxes = array_filter($boxes, function($item) {
//             return !empty($item->getRenderedContent());
//         });
//         if (isset($params['assign'])) {
...
//     } elseif (!empty($id)) {       /* custom - updated for shop5 compatibility to make the mobile menu work */
//         $categories = Category::getInstance();
//         $current = $categories->getCategoryById($id);

//         $list       = $current !== null && $current->hasChildren()
...
//         ? PFAD_ROOT . $image
//         : $image;
//     if (!file_exists($path) && is_string($path)) {
...
//      * @return void
//      */
//     function getCountry($params, $smarty): void
//     {
...
//  * @return void
//  */
// function getUploaderLang($params, $smarty): void
// {
//     $availableLocales = [
