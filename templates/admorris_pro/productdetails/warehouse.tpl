...
{if $anzeige !== 'nichts'
    ...
    {if $tplscope === 'detail'}
        <a class="btn-store-availability" data-toggle="popover" data-placement="left" data-ref="#popover-warehouse" data-trigger="click hover">
            {lang key='availability' section='productDetails' assign='productDetailLangKey'}
            {$admIcon->renderIcon('mapMarker', 'icon-content icon-content--default', $productDetailLangKey)}
        </a>
    {/if}
