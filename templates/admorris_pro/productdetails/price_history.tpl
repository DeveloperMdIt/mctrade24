    ...
    {block name='productdetails-price-history-script'}
        <script type="module">
            var ctx = document.getElementById('priceHistoryChart').getContext('2d'),
                ...
                datasets: [
                    {
                        badge:            "{lang section='productDetails' key='PriceFlowTitle' printf=(string)$Einstellungen.preisverlauf.preisverlauf_anzahl_monate addslashes=true} " + "({JTL\Session\Frontend::getCurrency()->getName()})",
