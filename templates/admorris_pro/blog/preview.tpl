{block name='blog-preview'}
    ...
    <div itemprop="blogPost" itemscope itemtype="https://schema.org/BlogPosting" class="newsbox blog-preview{if $class} {$class}{/if}">
                    ...
                    <div class="newsbox-header">
                        {if !empty($newsItem->getPreviewImage())}
                            {block name='blog-preview-news-image'}
                                {link href=$newsItem->getURL() title=$title tabindex="-1" class="blog-preview__image-link"}
                ...
                {block name='blog-preview-news-body'}
                    <div class="newsbox-body">
                        {block name='blog-preview-heading'}
                            {link itemprop="url" href=$newsItem->getURL() title=$title class="newsbox-headline h4"}
