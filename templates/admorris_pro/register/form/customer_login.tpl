{block name='register-form-customer-login'}
    ...
    {block name='register-form-customer-login-submit'}
        {formgroup label-for=" " class="customer-login-buttons mb-0"}
            ...
            <div class="switcher">
                ...
                {block name='register-form-customer-forgot'}
                    {link class="btn btn-link btn-block mt-0 customer-login-buttons-forgot" href={get_static_route id='pass.php'}}
