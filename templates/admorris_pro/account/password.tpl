...
{block name='account-password'}
    ...
    {block name='account-password-content'}
        ...
        {block name='account-password-heading'}
            <h1 class="account-password__heading text-center">{lang key='forgotPassword' section='global'}</h1>
        {/block}
        <div class="stack mx-auto w-100 container--xs">
            {if $step !== 'confirm'}
                ...
                {block name='account-password-form-password-reset'}
                    {form id="passwort_vergessen"
                        ...
                        addhoneypot=true
                        slide=true}
                        {block name='account-password-form-password-reset-content'}                  <div class="required-info">{lang key='requiredInfo'}</div>
                        <fieldset>
                            {block name='account-password-form-reset-legend'}
                                <legend>
                                    {lang key='emailadress'}
                                </legend>
                            {/block}
            ...
            {else}
                {block name='account-password-form-password-reset-confirm'}
                    <div class="h3">
                        {block name='account-password-password-reset-confirm-title'}{lang key='customerInformation' section='global'}{/block}
                    </div>
