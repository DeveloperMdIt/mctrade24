{* admorris pro - customized *}
{* Warenkorb2PersMerge code moved to 'snippets/basket_merge.tpl' *}
{* no container and removed bootstrap row *}
{block name='account-index'}
    ...
    {block name='account-index-content'}
        ...
        {include 'snippets/basket_merge.tpl'}
