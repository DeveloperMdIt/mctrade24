{block name='account-my-account'}
    {block name='heading'}
        <h1>{lang key='welcome' section='login'} {$Kunde->cVorname} {$Kunde->cNachname}</h1>
    {/block}
    ...
    {block name='account-my-account-account-data'}
        {row class="account-data-item-row row-gap"}
                                    ...
                                    {block name='account-my-account-billing-address-billing-address'}
                                        <tr>
                                            <td class="min-w-sm">
                                                ...
                                                <small class="text-muted d-block">{$Kunde->cStrasse}
                        ...
                        {cardheader}
                            {block name='account-my-account-shipping-address-header'}
                                {row class="align-items-center"}
                                    {col}
                                        <h2 class="h3 mb-0">
                                            {link class='text-decoration-none' href="$cCanonicalURL?editLieferadresse=1"}
                                        ...
                                        {foreach $Bestellungen as $order}
                                            ...
                                            section='login'} {$order->cBestellNr}"
                                                ...
                                                <td class="text-right d-none d-md-table-cell">
                                                    ...
                                                    {/if}
                                                    {$admIcon->renderIcon('eye', 'icon-content')}
                                                </td>
                                            </tr>
                                        {/foreach}
                                        </tbody>
                ...
                {block name='account-my-account-rma'}
                    {card no-body=true class="account-rma"}
                            ...
                            {block name='account-my-account-rma-header'}
                                {row class="align-items-center"}
                                    {col class="d-flex align-items-center"}
                                        <h2 class="h3 mb-0">
                                            {if count($rmas) > 0}
                                                {link class='text-decoration-none' href="$cCanonicalURL?returns=1"}
                        ...
                        {if count($rmas) > 0}
                                ...
                                <table class="table table-vertical-middle table-hover">
                                    <tbody>
                                        {foreach $rmas as $rma}
                                            ...
                                            <tr class="clickable-row cursor-pointer" data-href="{$cCanonicalURL}?showRMA={$rma->id}">
                                                <td>
                            ...
                            {link class="btn btn-outline-secondary btn-block border-0" href="$cCanonicalURL?newRMA=0"}
