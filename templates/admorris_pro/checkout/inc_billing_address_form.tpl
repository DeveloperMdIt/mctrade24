                            ...
                            {col cols=12 md=6}
                                {block name='checkout-inc-billing-address-form-salutation'}
                                    ...
                                    {if isset($fehlendeAngaben.anrede)}
                                        <div class="form-error-msg" aria-live="assertive" role="alert" aria-atomic="true">{$admIcon->renderIcon('warning', 'icon-content icon-content--default')}
                                            {lang key='fillOut'}
                                        </div>
                                    {/if}
                                    {select name="anrede" id="salutation" class='custom-select' required=($Einstellungen.kunden.kundenregistrierung_abfragen_anrede === 'Y') autocomplete="billing sex" aria-invalid="{if isset($fehlendeAngaben.anrede)}true{else}false{/if}"}
                        ...
                        {col cols=12}
                            {block name='checkout-inc-billing-address-form-country'}
                                {formgroup
                                    ...
                                    {/if}
                                    {select name="land" id="billing_address-country" class="country-input custom-select js-country-select" required=true autocomplete="billing country" aria-invalid="{if isset($fehlendeAngaben.land)}true{else}false{/if}"}
                    ...
                    {block name='checkout-inc-billing-address-form-city-wrap'}
                        {col cols=12 md=4}
                            {block name='checkout-inc-billing-address-form-zip'}
                                {formgroup
                                    class="typeahead-required{if isset($fehlendeAngaben.plz)} has-error{/if}"
                                    label-for="postcode"
                                    ...
                                    {input
                                        ...
                                        aria-invalid="{if isset($fehlendeAngaben.plz)}true{else}false{/if}"
                                    }
                                {/formgroup}
                            {/block}
                        {/col}
                        {col cols=12 md=8}
                            {block name='checkout-inc-billing-address-form-city'}
                                {formgroup
                                    class="typeahead-required{if isset($fehlendeAngaben.ort)} has-error{/if}"
                                    label-for="city"
                            ...
                            {col cols=12}
                                {formgroup
                                    ...
                                    {if isset($fehlendeAngaben.ustid)}
                                        <div class="form-error-msg" aria-live="assertive">{$admIcon->renderIcon('warning', 'icon-content icon-content--default')}
