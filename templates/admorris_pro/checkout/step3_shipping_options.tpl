{block name='checkout-step3-shipping-options'}
    {block name='checkout-step3-shipping-options-heading'}
        <h1>{lang section='account data' key='shippingAndPaymentOptions'}</h1>
    {/block}
    {row class="checkout-shipping-form-wrapper justify-content-center"}
        {col cols=12 lg=9}
                                                    ...
                                                    {radio
                                                        ...
                                                        {formrow class="content"}
                                                            ...
                                                            {block name='checkout-step3-shipping-options-shipping-option-info'}
                                                                {col cols=12 sm=3}<small class="desc text-primary">{$versandart->cLieferdauer|transByISO}</small>{/col}
                                                            {/block}
                            ...
                            {block name='checkout-step3-shipping-options-shipping-type-submit'}
                                {row class="checkout-button-row"}
                                    {col cols=12 md=5 class='ml-auto order-1 order-md-2'}
                                        ...
                                        {button type="submit" variant="primary" class="submit_once button-row-mb" block=true}
                                            {lang key='continueOrder' section='account data'}
                                        {/button}
                                    {/col}
                                    {col cols=12 md=4 class='order-2 order-md-1'}
                                        {button block=true type="link" href="{get_static_route id='bestellvorgang.php'}?editRechnungsadresse=1" variant="outline-secondary"}
                                            {lang key='back'}
                                        {/button}
                                    {/col}
                                {/row}
